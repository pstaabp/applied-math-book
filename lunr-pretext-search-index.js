...
},
{
  ...
  "body": " Linear Systems  We start this section with three examples of linear systems. One is about a biathlon with running and biking legs, a traffic flow model and finally an example from Chemistry. Examples of linear systems are found from every mathematical subfield and every science.   Biathlon Example   Travis runs 6 mph and bikes 18 mph in a race with two events. If the course is 29 miles long and it takes him 2 hours and 10 minutes to complete the race, how long is each segment?    In this case, we need to know how long each segment is. There are two legs to the race, so we will let     The equations come from three statements in the problem above. First, we know that the total course is 29 miles long or     The remaining equation arises from the time it takes Travis to complete the race. In general recall the relationship between speed (a rate), distance and time is     or solving for time,     For example, the time it takes Travis to finish the running leg is . The total time it takes Travis to finish the race is     so the linear system is       The next example examines the traffic flow in a very limited part of a city (Boston in this case).   Traffic Flow  A simple model of traffic flow can be represented by the following graph:   A map of a few streets in Boston where the arrows denote the direction of traffic flow (all of these streets are one-way) and the numbers represent the numbers of cars driving down the street in a given time period. The letters through will be the names of the intersections.      And a mathematical model can be written down by making sure that the total number of cars that go into an intersection balances with the number of cars exiting. In this case, we have:     for intersections , , and respectively.   Linear equations exist in many different fields, especially the sciences. The following comes from Chemistry in which a chemical equation is found by balancing the number of atoms in the equation on both sides.   Chemical Reactions  Hydrazine ( ) is an important nitrogen-based compound. A chemical reaction to produce it from ammonia and hydrogen peroxide is given by     The values of and can be found by solving the following linear system which balances the number of nitrogen (N), hydrogen (H) and oxygen (O) atoms respectively in the reaction or      With examples of linear algebra presented, we next move to a few definitions.       A linear combination of has the form     where the constants are the combinations coefficients.    A linear equation has the form     where is a constant.    The -tuple  satisfies or is a solution of ( ) if this point satisfies ( ) or       A system of linear equations or linear system is a set of linear equations:     and this linear system has equations and unknowns (variables).    The -tuple  satisfies or is a solution of ( ) if this point satisfies every equation of ( ).        Linear Equations  The following are linear equations:     where summation notation has been used in the last one and note that other variables names can be used. The following equations are not linear:     Each of the equations in the latter group have multiplications, squares division or other functions between variables.   The next two examples give a way to determine if a point or -tuple is a solution to a linear system.   Showing a Point is a Solution to a Linear System   Show that the point is a solution of the linear system:       Substitute and into both equations and check.     Since each equation is satisfied at the point is a solution to the linear system.      Recall that the linear system in Example can be written:     Is a solution to this linear system? Is ? Is ?    For , we need to substitute this point in and check all the equations:     so it is a solution.  For , again check all of the equations:     so this is also a solution.  For , we substitute this into the equation:     and it satisfies 2 of the equations, but not all, so this is not a solution.      "
},
{
  "id": "ex-biathlon",
  "level": "2",
  ...
  "body": " Biathlon Example   Travis runs 6 mph and bikes 18 mph in a race with two events. If the course is 29 miles long and it takes him 2 hours and 10 minutes to complete the race, how long is each segment?    In this case, we need to know how long each segment is. There are two legs to the race, so we will let     The equations come from three statements in the problem above. First, we know that the total course is 29 miles long or     The remaining equation arises from the time it takes Travis to complete the race. In general recall the relationship between speed (a rate), distance and time is     or solving for time,     For example, the time it takes Travis to finish the running leg is . The total time it takes Travis to finish the race is     so the linear system is      "
},
{
  "id": "ex-streets",
  "level": "2",
...
},
{
  ...
  "body": " Chemical Reactions  Hydrazine ( ) is an important nitrogen-based compound. A chemical reaction to produce it from ammonia and hydrogen peroxide is given by     The values of and can be found by solving the following linear system which balances the number of nitrogen (N), hydrogen (H) and oxygen (O) atoms respectively in the reaction or     "
},
{
  ...
  "number": "1.1.5",
  "title": "",
  "body": "     A linear combination of has the form     where the constants are the combinations coefficients.    A linear equation has the form     where is a constant.    The -tuple  satisfies or is a solution of ( ) if this point satisfies ( ) or       A system of linear equations or linear system is a set of linear equations:     and this linear system has equations and unknowns (variables).    The -tuple  satisfies or is a solution of ( ) if this point satisfies every equation of ( ).      "
},
{
...
},
{
  ...
  "number": "1.3.12",
  "title": "",
  "body": "  The non-leading variables in a linear system in echelon form are called the free variables or parameters .   "
},
{
...
},
{
  ...
  "number": "1.3.14",
  "title": "",
  "body": "  Find the solution set of the linear system in        We will first put this into an augmented matrix, then use Gauss's methodl         Rewriting as equations results in     or solving for the leading variables      Since and all depend on , a free variable, there are an infinite number of solutions to this linear system. We can write this as     Solutions include , , .  Since the above example comes from Chemical equations, it is desirable to find a solution of all positive integers, since the number represent the number of atoms in the reaction. In addition, typically the solution with smallest integers is desired. In this case, the solution results in the following equation:    "
},
{
  ...
  "number": "1.3.15",
  "title": "",
  "body": "  If matrix can be converted to matrix by elementary row operations, then we say that and are row equivalent or just equivalent .   "
},
{
...
{
  "id": "sect-gaussian-elimination-8-17",
  "level": "2",
  "url": "sect-gaussian-elimination.html#sect-gaussian-elimination-8-17",
  "type": "Lemma",
  "number": "1.3.21",
  "title": "",
  "body": "  If two echelon form matrices are row equivalent then the leading entries in their first rows lie in the same column. The same is true of all the nonzero rows---the leading entries in their second rows lie in the same column, etc.   "
},
{
...
},
{
  ...
  "number": "1.4.1",
  "title": "",
  "body": "  The vector in (xref ref=\"eq-column-vector\" \/> is a solution to a linear equation      if     A vector is a solution to a linear system if the points satisfy each equation in the solution. We consider the vector in similar to the tuple .   "
},
{
  "id": "def-",
  "level": "2",
...
},
{
  ...
  "number": "1.5.2",
  "title": "",
  "body": "  A linear equation is homogeneous if the constant term (on the right hand side) is 0. A linear system is homogeneous if all constant terms is 0.   "
},
{
...
},
{
  ...
  "body": " Matrix Operations   As we have seen, a matrix is a group of numbers arranged in a rectangular block. An by matrix has rows and columns.  For example, is a 2 by 4 matrix.  The size of a matrix is the number of rows and columns in the matrix. The number of rows is listed first. The size of the example above is 2 by 4.  The numbers in a matrix are called the entries or elements of the matrix. For example, for the matrix in ( ), the entry on the first row and third column is 11. Often we will use the notation , where the subscript 1 is the row number and is the column number.   Matrix, Vector and Scalar Notation  A scalar is a fancy term for a number. Mathematicians use this term to distinguish them from matrices and vectors, which are not scalars. Whenever variables are used for scalars, then lower case letters will be used. For example, and are scalar variables.  When we use variable names for matrices, we will use capital letters. For example, and are matrix (or vector) variables.   Addition and Subtraction of Matrices  In this section, we learn how to perform some basic operations between matrices. First, we will look at adding and subtracting two matrices and later we will look at multiplying a matrix by a scalar (a number).    In this case, let and and are matrices. Then    is the matrix formed by each entry is . That is multiply each entry by .   is the matrix form by each entry is . That is to add matrices, we add element by element.   is the matrix form by each entry is . That is to add matrices, we subtract element by element.  If and are not the same size then and does not exist.   Note: an alternative definition of matrix subtraction, , which is consistent with subtraction of real numbers.   Let Then the sum is found by adding the individual elements. similarly we can subtract in the same way      Find the following result or state that it does not exist.     Since the matrices are not the same size, this operation is not valid.      Scalar Multiplication of Vectors and Matrices  Scalar multiplication of vectors and matrices is a simple operation where the result is the scalar times each element of the vector or matrix.    Evaluate:                     Transpose   The last basic matrix operation that we will cover here in the transpose of a matrix. As an example, if then the transpose is the matrix, given by where the row and column of each element is flipped.  The transpose of an matrix , denoted is flipped over the diagonal. In particular, the element in the th row and th column of is given by the th row and column of .   We will see that transposes play a big role in linear algebra.   Properties of Transposes         .        Multiplication of Vectors and Matrices  In an perhaps backwards way of thinking, we will start with the product of two matrices. We will then see that the product of matrices and vectors and then vectors and vectors can be seen in the same manner.   Let and be matrices. The product of and , or can be found in the following manner. Element is the dot product of the th row of and the th column of .  Note: In order for the dot product to be defined, the number columns of must equal the number of rows of . If not the product is not defined.   Also if the product is defined, the result, has the same number of rows of and the same number of columns as .   Find if    First, since the number of rows of is 2 and the number of columns of is 2, the size of is 2.   The 1st row and 1st column of is the 1st row of times the 1st column of .  The 1st row and 2nd column of is the 1st row of times the 2nd column of .  The 2nd row and 1st column of is the 2nd row of times the 1st column of .  The 2nd row and 2nd column of is the 2nd row of times the 2nd column of .  We now explicitly show the dot products.      Size Restrictions on Matrices  Note that for each element in the resulting matrix, there is a vector-vector product, coming from each row of the first matrix and each column of the second matrix:  The number of columns of the first matrix must equal the number of rows of the second matrix.  The size of the resulting matrix can also be found by the sizes of the input matrices.  If the matrices and are multiplied then this diagram helps with a valid product as well as the size of the result.  Diagram of valid dimensions for matrix product.      That is if is by and is by , then has size by .    Let be a matrix that is 2 by 3, be a matrix that is 3 by 3 and be a matrix that is 2 by 2. Determine which of the following products are valid and if the product is valid, list its size.                Since is 2 by 3 and is 3 by 3, the inner numbers are equal and thus multiplication is valid and the result is 2 by 3.  Since is 2 by 3 and is 2 by 2, the inner numbers are not equal, so multiplication is not valid.  Since is 3 by 3 and is 2 by 2, the inner numbers are not equal, so multiplication is not valid.  Since is 3 by 3 and is 2 by 3, the inner numbers are not equal, so multiplication is not valid.  Since is 2 by 2 and is 2 by 3, the inner numbers are equal so multiplication is valid and the result are the outer numbers or 2 by 3.  In this case, from (e), the size of is 2 by 3 and is 3 by 3, so the inner numbers are equal so multiplication is valid and the result is 2 by 3.       Let find if this is a valid operation.    The size of is 3 by 2 and the size of is 2 by 2, so the inner numbers are equal and thus this operations is valid. The size of the result is 3 by 2.      Matrix-Vector Multiplication  Since a vector can be thought of as a matrix, the matrix-vector product (and vector-matrix products) exist if they are compatible. If is a matrix and is a column vector of size , then the result is valid.    Let Find .   This product is found by taking the dot product of rows of and .      Reexamination of the Dot Product  Recall that the dot product of two vectors and of the same length discussed in is the sum of the products of the individual elements.  We can see that the dot product can also be defined as or alternatively using summation notation     Matrix Multiplication and Linear Systems  In this section, we will learn an alternative way to look at a linear system and in the next section, we will solve it. Consider the following linear system. This can be written as: The first matrix is simply the coefficient matrix without the last column. The column vector on the right hand side is that last column in the coefficient matrix.  To show that this matrix equation is identical to the linear system above, we use matrix multiplication to get: and since two vectors are equal if each of the corresponding elements are equal, this is the same as the linear system above.  If we let then the linear system can be written as In the next section we will learn a way to solve a linear system in this way using an alternative method to Gauss' method.    "
},
{
  "id": "sec-matrix-operations-2-3",
  "level": "2",
  "url": "sec-matrix-operations.html#sec-matrix-operations-2-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "size "
...
{
  "id": "sec-matrix-operations-2-4",
  "level": "2",
  "url": "sec-matrix-operations.html#sec-matrix-operations-2-4",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "sec-matrix-operations-3-2",
  "level": "2",
  "url": "sec-matrix-operations.html#sec-matrix-operations-3-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "scalar "
...
{
  "id": "sec-matrix-operations-4-3",
  "level": "2",
  "url": "sec-matrix-operations.html#sec-matrix-operations-4-3",
  "type": "Definition",
  "number": "2.1.1",
  "title": "",
  "body": "  In this case, let and and are matrices. Then    is the matrix formed by each entry is . That is multiply each entry by .   is the matrix form by each entry is . That is to add matrices, we add element by element.   is the matrix form by each entry is . That is to add matrices, we subtract element by element.  If and are not the same size then and does not exist.  "
},
{
  "id": "sec-matrix-operations-4-5",
  "level": "2",
  "url": "sec-matrix-operations.html#sec-matrix-operations-4-5",
  "type": "Example",
  "number": "2.1.2",
  "title": "",
...
{
  "id": "sec-matrix-operations-4-6",
  "level": "2",
  "url": "sec-matrix-operations.html#sec-matrix-operations-4-6",
  "type": "Example",
  "number": "2.1.3",
  "title": "",
...
{
  "id": "sec-matrix-operations-5-3",
  "level": "2",
  "url": "sec-matrix-operations.html#sec-matrix-operations-5-3",
  "type": "Example",
  "number": "2.1.4",
  "title": "",
  "body": "  Evaluate:                   "
...
{
  "id": "sect-transpose-2-2",
  "level": "2",
  "url": "sec-matrix-operations.html#sect-transpose-2-2",
  "type": "Definition",
  "number": "2.1.5",
  "title": "",
  "body": "The transpose of an matrix , denoted is flipped over the diagonal. In particular, the element in the th row and th column of is given by the th row and column of . "
},
{
  "id": "sect-transpose-4",
  "level": "2",
  "url": "sec-matrix-operations.html#sect-transpose-4",
  "type": "Lemma",
  "number": "2.1.6",
  "title": "Properties of Transposes.",
  "body": " Properties of Transposes         .     "
},
{
  "id": "sect-mult-matrix-3",
  "level": "2",
  "url": "sec-matrix-operations.html#sect-mult-matrix-3",
  "type": "Definition",
  "number": "2.1.7",
  "title": "",
  "body": " Let and be matrices. The product of and , or can be found in the following manner. Element is the dot product of the th row of and the th column of .  Note: In order for the dot product to be defined, the number columns of must equal the number of rows of . If not the product is not defined.  "
},
{
  "id": "sect-mult-matrix-5",
  "level": "2",
  "url": "sec-matrix-operations.html#sect-mult-matrix-5",
  "type": "Example",
  "number": "2.1.8",
  "title": "",
...
{
  "id": "sec-matrix-operations-8-3",
  "level": "2",
  "url": "sec-matrix-operations.html#sec-matrix-operations-8-3",
  "type": "Remark",
  "number": "2.1.9",
  "title": "",
...
{
  "id": "sec-matrix-operations-8-5",
  "level": "2",
  "url": "sec-matrix-operations.html#sec-matrix-operations-8-5",
  "type": "Remark",
  "number": "2.1.10",
  "title": "",
...
{
  "id": "sec-matrix-operations-8-6",
  "level": "2",
  "url": "sec-matrix-operations.html#sec-matrix-operations-8-6",
  "type": "Example",
  "number": "2.1.12",
  "title": "",
...
{
  "id": "sec-matrix-operations-8-7",
  "level": "2",
  "url": "sec-matrix-operations.html#sec-matrix-operations-8-7",
  "type": "Example",
  "number": "2.1.13",
  "title": "",
...
{
  "id": "sec-matrix-operations-9-3",
  "level": "2",
  "url": "sec-matrix-operations.html#sec-matrix-operations-9-3",
  "type": "Example",
  "number": "2.1.14",
  "title": "",
  "body": "  Let Find .   This product is found by taking the dot product of rows of and .    "
},
{
...
{
  "id": "sect-matrix-inverse-6-2",
  "level": "2",
  "url": "sect-matrix-inverse.html#sect-matrix-inverse-6-2",
  "type": "Lemma",
  "number": "2.2.2",
  "title": "",
  "body": "  The inverse of a 2 by 2 matrix is given by     if . If , the matrix does not have an inverse.    We will prove this, by showing that if is an inverse then (or ).     Although we haven't shown this, the scalar can be written out front.     Multiply the two matrices like we did in the previous section.     simplify and multiply through by .     And since we have shown that , this proves the formula for the inverse in ( ).   "
},
{
  "id": "sect-matrix-inverse-6-4",
  "level": "2",
  "url": "sect-matrix-inverse.html#sect-matrix-inverse-6-4",
  "type": "Example",
  "number": "2.2.3",
  "title": "",
  "body": "  Find the inverse of       Since ( ) has the determinant of as part of it, first, we will find . Then apply the formula,      "
},
{
...
{
  "id": "sect-matrix-inverse-8-8",
  "level": "2",
  "url": "sect-matrix-inverse.html#sect-matrix-inverse-8-8",
  "type": "Example",
  "number": "2.2.8",
  "title": "",
...
{
  "id": "sect-matrix-inverse-8-12",
  "level": "2",
  "url": "sect-matrix-inverse.html#sect-matrix-inverse-8-12",
  "type": "Example",
  "number": "2.2.10",
  "title": "",
...
{
  "id": "sect-matrix-inverse-8-13",
  "level": "2",
  "url": "sect-matrix-inverse.html#sect-matrix-inverse-8-13",
  "type": "Example",
  "number": "2.2.11",
  "title": "",
...
{
  "id": "sect-matrix-inverse-8-15",
  "level": "2",
  "url": "sect-matrix-inverse.html#sect-matrix-inverse-8-15",
  "type": "Example",
  "number": "2.2.12",
  "title": "",
...
{
  "id": "sect-elem-matrices-13",
  "level": "2",
  "url": "sect-elem-matrices.html#sect-elem-matrices-13",
  "type": "Example",
  "number": "2.3.2",
  "title": "",
...
{
  "id": "sect-elem-matrices-15",
  "level": "2",
  "url": "sect-elem-matrices.html#sect-elem-matrices-15",
  "type": "Theorem",
  "number": "2.3.3",
  "title": "",
...
{
  "id": "sect-elem-matrices-18",
  "level": "2",
  "url": "sect-elem-matrices.html#sect-elem-matrices-18",
  "type": "Lemma",
  "number": "2.3.5",
  "title": "",
...
{
  "id": "sect-elem-matrices-20",
  "level": "2",
  "url": "sect-elem-matrices.html#sect-elem-matrices-20",
  "type": "Example",
  "number": "2.3.6",
  "title": "",
...
{
  "id": "sect-linear-comb-span-19",
  "level": "2",
  "url": "sect-linear-comb-span.html#sect-linear-comb-span-19",
  "type": "Example",
  "number": "2.4.5",
  "title": "",
...
{
  "id": "sect-linear-independence-7",
  "level": "2",
  "url": "sect-linear-independence.html#sect-linear-independence-7",
  "type": "Example",
  "number": "2.5.4",
  "title": "",
...
{
  "id": "sect-linear-independence-9",
  "level": "2",
  "url": "sect-linear-independence.html#sect-linear-independence-9",
  "type": "Example",
  "number": "2.5.5",
  "title": "",
...
{
  "id": "sect-linear-independence-11",
  "level": "2",
  "url": "sect-linear-independence.html#sect-linear-independence-11",
  "type": "Theorem",
  "number": "2.5.6",
  "title": "",
...
{
  "id": "sect-row-col-space-rank-3-3",
  "level": "2",
  "url": "sect-row-col-space-rank.html#sect-row-col-space-rank-3-3",
  "type": "Example",
  "number": "2.6.2",
  "title": "",
...
{
  "id": "sect-row-col-space-rank-3-4",
  "level": "2",
  "url": "sect-row-col-space-rank.html#sect-row-col-space-rank-3-4",
  "type": "Example",
  "number": "2.6.3",
  "title": "",
...
{
  "id": "sect-row-col-space-rank-3-5",
  "level": "2",
  "url": "sect-row-col-space-rank.html#sect-row-col-space-rank-3-5",
  "type": "Lemma",
  "number": "2.6.4",
  "title": "",
...
{
  "id": "sect-row-col-space-rank-3-6",
  "level": "2",
  "url": "sect-row-col-space-rank.html#sect-row-col-space-rank-3-6",
  "type": "Lemma",
  "number": "2.6.5",
  "title": "",
...
{
  "id": "sect-row-col-space-rank-3-8",
  "level": "2",
  "url": "sect-row-col-space-rank.html#sect-row-col-space-rank-3-8",
  "type": "Remark",
  "number": "2.6.6",
  "title": "",
...
{
  "id": "sect-row-col-space-rank-3-9",
  "level": "2",
  "url": "sect-row-col-space-rank.html#sect-row-col-space-rank-3-9",
  "type": "Example",
  "number": "2.6.7",
  "title": "",
...
{
  "id": "sect-row-col-space-rank-4-3",
  "level": "2",
  "url": "sect-row-col-space-rank.html#sect-row-col-space-rank-4-3",
  "type": "Example",
  "number": "2.6.9",
  "title": "",
...
{
  "id": "sect-row-col-space-rank-4-5",
  "level": "2",
  "url": "sect-row-col-space-rank.html#sect-row-col-space-rank-4-5",
  "type": "Remark",
  "number": "2.6.10",
  "title": "",
...
{
  "id": "sect-row-col-space-rank-5-4",
  "level": "2",
  "url": "sect-row-col-space-rank.html#sect-row-col-space-rank-5-4",
  "type": "Remark",
  "number": "2.6.16",
  "title": "",
...
},
{
  ...
  "number": "2.6.19",
  "title": "",
  "body": " Show that the Rank-Nullity Theorem holds for Examples and .   In Example , the matrix is reduced to reduced row echelon form and it shows that there are 2 non-zero rows, hence the rank of the matrix is 2. Also in Example , the nullity was shown to be 1 and the sum is 3, the number of columns of .  In Example , the matrix is reduced to reduced row echelon form and it shows that there are 2 non-zero rows, and again the rank of the matrix is 2. The example also shows that the nullity is 2 and the sum is 4, the number of columns of .   "
},
{
  "id": "sect-det",
  "level": "1",
...
},
{
  "id": "sect-det-3-9",
  "level": "2",
  "url": "sect-det.html#sect-det-3-9",
  "type": "Remark",
  "number": "2.7.2",
  "title": "",
  "body": " If     then     "
},
{
  "id": "sect-det-3-10",
  "level": "2",
  "url": "sect-det.html#sect-det-3-10",
  "type": "Lemma",
  "number": "2.7.3",
  "title": "",
...
},
{
  "id": "sect-det-4-2",
  "level": "2",
  "url": "sect-det.html#sect-det-4-2",
  "type": "Example",
  "number": "2.7.4",
  "title": "",
...
},
{
  ...
  "number": "2.7.5",
  "title": "",
  "body": "  Use Gauss's method to find the determinants of the following matrices:              "
},
{
  "id": "sect-det-5-3",
  "level": "2",
...
},
{
  "id": "sect-det-5-4",
  "level": "2",
  "url": "sect-det.html#sect-det-5-4",
  "type": "Example",
  "number": "2.7.7",
  "title": "",
...
},
{
  "id": "sect-det-5-6",
  "level": "2",
  "url": "sect-det.html#sect-det-5-6",
  "type": "Theorem",
  "number": "2.7.8",
...
},
{
  "id": "sect-det-5-7",
  "level": "2",
  "url": "sect-det.html#sect-det-5-7",
  "type": "Example",
  "number": "2.7.9",
  "title": "",
...
},
{
  ...
  "number": "2.7.10",
  "title": "",
  "body": " Plot of two intersecting lines     "
},
{
...
},
{
  "id": "sect-det-6-3-10",
  "level": "2",
  "url": "sect-det.html#sect-det-6-3-10",
  "type": "Definition",
  "number": "2.7.14",
  "title": "",
...
},
{
  "id": "sect-det-6-3-11",
  "level": "2",
  "url": "sect-det.html#sect-det-6-3-11",
  "type": "Example",
  "number": "2.7.15",
  "title": "",
...
{
  "id": "sect-vector-spaces-3-3",
  "level": "2",
  "url": "sect-vector-spaces.html#sect-vector-spaces-3-3",
  "type": "Lemma",
  "number": "3.1.2",
  "title": "",
...
{
  "id": "sect-vector-spaces-3-9",
  "level": "2",
  "url": "sect-vector-spaces.html#sect-vector-spaces-3-9",
  "type": "Example",
  "number": "3.1.4",
  "title": "",
...
{
  "id": "sect-vector-spaces-4-4",
  "level": "2",
  "url": "sect-vector-spaces.html#sect-vector-spaces-4-4",
  "type": "Example",
  "number": "3.1.5",
  "title": "",
...
},
{
  ...
  "number": "3.2.7",
  "title": "",
  "body": "  Show using that     the set of all diagonal matrices is a subspace of .    In this case, if we show that for any two matrices     and scalars that is in the set.     which is a diagonal matrix, therefore in , thus this is a subspace.   "
},
{
  ...
  "number": "3.2.8",
  "title": "",
  "body": "  Let be an by matrix. The null space of is a subspace of .    We will use lemma to solve this. Let both and be in the null space of . This means that and . We need to show that is in the null space of .     Vectors in the null space are vectors of length , so the null space is a subset of and since is in the null space of , then the null space is a subspace of .   "
},
{
...
},
{
  ...
  "number": "3.2.28",
  "title": "",
  "body": "     The dimension of is . Although there are many bases, consider , the natural basis, which has elements.    The dimension of is . The natural basis of is with elements.    The dimension of the vector space of all 2 by 2 matrices is 4. A natural basis for this is: and since there are 4 elements, the dimension is 4.      "
},
{
...
{
  "id": "sect-eigenvalues-2-3",
  "level": "2",
  "url": "sect-eigenvalues.html#sect-eigenvalues-2-3",
  "type": "Example",
  "number": "4.1.2",
  "title": "",
...
{
  "id": "sect-finding-eigenvalues-eigenvectors-19",
  "level": "2",
  "url": "sect-eigenvalues.html#sect-finding-eigenvalues-eigenvectors-19",
  "type": "Theorem",
  "number": "4.1.6",
  "title": "",
  "body": "  Let be a real matrix. If is an complex eigenvalue with corresponding eigenvector, , then the complex conjugate of denoted is also an eigenvalue with corresponding complex conjuate eigenvector .    If , is an eigenvalue-eigenvector pair of , then     And taking the complex conjugate of this equation.     where because is real. This shows that , is a eigenvalue-eigenvector pair of .   "
},
{
  "id": "sect-finding-eigenvalues-eigenvectors-21",
  "level": "2",
  "url": "sect-eigenvalues.html#sect-finding-eigenvalues-eigenvectors-21",
  "type": "Example",
  "number": "4.1.7",
  "title": "",
...
},
{
  ...
  "number": "4.1.8",
  "title": "",
  "body": "  Find the eigenvalues and eigenvectors of       This has the characteristic equation or the single root . To find the eigenvectors we find the null space of or     and any vector in is in the null space. We can write down the space using the standard basis vectors     so and are both eigenvectors associated with .   "
},
{
  "id": "ex-eigs-3by3",
  "level": "2",
...
{
  "id": "sect-linear-maps-eigen-6",
  "level": "2",
  "url": "sect-linear-maps-eigen.html#sect-linear-maps-eigen-6",
  "type": "Example",
  "number": "4.2.2",
  "title": "",
...
{
  "id": "sect-linear-maps-eigen-8",
  "level": "2",
  "url": "sect-linear-maps-eigen.html#sect-linear-maps-eigen-8",
  "type": "Example",
  "number": "4.2.3",
  "title": "",
...
},
{
  ...
  "number": "7.1.5",
  "title": "",
  "body": "  A differential equation is an equation that contains derivatives. If the differential equation has partial derivatives, then the equation is called a partial differential equation , if not it is called an ordinary differential equation. The order of the PDE is the highest degree of any derivative. If the equation is linear in , the dependent variable and its derivatives, then the equation is linear , if not, it is nonlinear . Lastly, a linear differential equation is called homogeneous if the only nonzero terms in the equation contain the dependent variable. If a differential equation is not homogeneous, then it is called nonhomogeneous .   "
},
{
...
},
{
  ...
  "number": "7.2.3",
  "title": "",
  "body": " The one-dimensional heat equation is     and is typically solved for a given initial condition and often with boundary conditions.  "
},
{
  "id": "fig-wave-eqn",
  "level": "2",
...
{
  "id": "sect-linear-ode-3-13",
  "level": "2",
  "url": "sect-linear-ode.html#sect-linear-ode-3-13",
  "type": "Example",
  "number": "7.3.4",
  "title": "",
  "body": "  Find the general solution to .    The characteristic equation is     Thus the general solution is     However, we will use Euler's Formula:     to write the equation as a real function:     letting ,       "
},
{
  ...
  "number": "7.3.5",
  "title": "",
  "body": "  Find the solution to .    The characteristic equation for this differential equation is     and since this can't be factored, we'll use the quadratic equation to solve this:     and using the general solution to this would be written     where and .   "
},
{
  ...
  "number": "7.3.6",
  "title": "",
  "body": "  Consider the general 2nd-order constant-coefficient linear homogeneous differential equation,     and let and be the roots of the characteristic equation.     If and are real and distinct, then the general solution to is       If is the only real root of the characteristic equation then the general solution to is       If the roots of the characteristic equation are pure imaginary, that is and , then the solution to is       and if the roots of the characteristic equation are complex conjugates, that is and , then the solution to ( ) is          First, recall that the characteristic equation of ( ) is     We will prove each statement in order.     The derivatives of ( ) are     and substituting these into ( ),     rearranging     and since and are roots of the characteristic equation, then both terms in parentheses are zero and       The derivatives of are     where the product rule has been used. In this case, recall also that since is the only real root, that from the quadratic formula with the discriminant . Substituting into      where the term with factor and the term with factor are each 0, because is a root of the characteristic equation. Lastly, the term with factor is 0 because as stated about . \\item Note that since the roots are pure imaginary, then then in ( ) and therefore and satisfy and since , then . The derivatives of ( ) are     and then substituting into ( ) with ,     since .    In this case, since the roots are complex conjugates, we can write and . The characteristic equation can be written:     which implies that and . The derivatives of are     and substituting them into ,     And using and , the right hand side of ( ) is 0, therefore ( ) is a solution.      "
},
{
  "id": "ch-pde-6",
  "level": "1",
