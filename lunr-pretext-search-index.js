...
{
  "id": "sect-gram-schmidt-2",
  "level": "2",
  "url": "sect-inner-product.html#sect-gram-schmidt-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Gram-Schmidt "
...
{
  "id": "sect-gram-schmidt-4",
  "level": "2",
  "url": "sect-inner-product.html#sect-gram-schmidt-4",
  "type": "Example",
  "number": "4.4.12",
  "title": "",
...
{
  "id": "sect-gram-schmidt-6",
  "level": "2",
  "url": "sect-inner-product.html#sect-gram-schmidt-6",
  "type": "Remark",
  "number": "4.4.13",
  "title": "",
...
{
  "id": "sect-gram-schmidt-7",
  "level": "2",
  "url": "sect-inner-product.html#sect-gram-schmidt-7",
  "type": "Proof",
  "number": "4.4.4.1",
...
{
  "id": "sect-gram-schmidt-8",
  "level": "2",
  "url": "sect-inner-product.html#sect-gram-schmidt-8",
  "type": "Example",
  "number": "4.4.14",
  "title": "",
...
{
  "id": "subsect-matrix-form-linear-transformation-3",
  "level": "2",
  "url": "sect-linear-transformations.html#subsect-matrix-form-linear-transformation-3",
  "type": "Remark",
  "number": "4.5.10",
  "title": "",
...
{
  "id": "subsect-matrix-form-linear-transformation-5",
  "level": "2",
  "url": "sect-linear-transformations.html#subsect-matrix-form-linear-transformation-5",
  "type": "Example",
  "number": "4.5.11",
  "title": "",
...
{
  "id": "subsect-matrix-form-linear-transformation-9",
  "level": "2",
  "url": "sect-linear-transformations.html#subsect-matrix-form-linear-transformation-9",
  "type": "Example",
  "number": "4.5.13",
  "title": "",
...
{
  "id": "ex-projection-plane",
  "level": "2",
  "url": "sect-projection-maps.html#ex-projection-plane",
  "type": "Example",
  "number": "4.6.6",
  "title": "",
...
{
  "id": "sect-projection-maps-5-4",
  "level": "2",
  "url": "sect-projection-maps.html#sect-projection-maps-5-4",
  "type": "Remark",
  "number": "4.6.9",
  "title": "",
...
{
  "id": "sect-projection-maps-5-5",
  "level": "2",
  "url": "sect-projection-maps.html#sect-projection-maps-5-5",
  "type": "Example",
  "number": "4.6.10",
  "title": "",
...
{
  "id": "sect-orthogonal-matrices",
  "level": "1",
  "url": "sect-orthogonal-matrices.html",
  "type": "Section",
  "number": "5.3",
  "title": "Orthogonal Matrices",
  "body": " Orthogonal Matrices   In this chapter, we explore matrices that have special properties and their applications to quadratic forms. We will see that symmetric matrices have real eigenvalues and orthogonal eigenvectors, and that we can use these properties to simplify quadratic forms.  Before defining a orthogonal matrix and its corresponding transformation, let's recall a few definitions and theorems about symmetric matrices.    A square matrix is said to be symmetric if .    The next theorem is an important result about the eigenvalues of symmetric matrices, and it will be used in the next section to show that the eigenvectors of a symmetric matrix are orthogonal.    The eigenvalues of a symmetric matrix are real.    Let be an eigenvalue of with corresponding eigenvector that is:     Left multiply by    resulting in   Next, take the transpose of and recall that  where the symmetry of has been employed. Take the complex conjugate of the above equation: where has been used because is a real matrix. Right multiply this by  Solving this for results in which is identical to showing that which shows that is real.      The eigenvectors of a symmetric matrix are orthogonal.    Let and be two distinct eigenvalues of a symmetric matrix with corresponding eigenvectors and . Then and Left multiply the first equation by and the second equation by to get Since is symmetric, then . Therefore, Since the eigenvalues are distinct, then which implies that .      A square matrix is said to be orthogonal if     for all . If in addition that for all then the matrix is also said to be orthonormal .    Sometimes orthogonal matrices also have the condition that each column has length 1.    If is a orthonormal matrix, then .     This is the same as showing that , which is the definition of an orthonormal matrix.   The last theorem in this section is about the determinants. We show that the determinant of a orthogonal matrix is either 1 or -1.    If is an orthogonal matrix, then or .    Recall that from , then from  Then since the determinant is a real number, then or .      The Transformation as an Orthogonal Matrix  Recall that as discussed in that matrix multiplication is a linear transformation. In short, transformations with these matrices are isometries, in which the geometry of the transformation is preserved. That is, if is an orthogonal matrix, then the following are preserved.   Length  The length of the vector stays the same. That is, .    Angle  The angle between two vectors and stays the same. That is, .    Volume  The volume of a shape is preserved. That is, if is a shape in , then the volume of is the same as the volume of .      The proof of the length is shown and the remainder is left to the reader. Without loss of generality, we will find the square of the length of the vector or where is used from .     Constructing Orthogonal Matrices  Let's look at orthogonal matrices. A general matrix has the form: Since each column has a norm of 1 and the columns are orthogonal then We can let , resulting in and resulting in . The third equation shows One such solution to this is , which would give the matrix: which is a rotation matrix that takes a vector in and rotates the vector counter-clockwise radians. An alternative solution to is and this would result in the matrix:    "
},
{
  "id": "sect-orthogonal-matrices-2-3",
  "level": "2",
  "url": "sect-orthogonal-matrices.html#sect-orthogonal-matrices-2-3",
  "type": "Definition",
  "number": "5.3.1",
  "title": "",
...
{
  "id": "sect-orthogonal-matrices-2-5",
  "level": "2",
  "url": "sect-orthogonal-matrices.html#sect-orthogonal-matrices-2-5",
  "type": "Theorem",
  "number": "5.3.2",
  "title": "",
  "body": "  The eigenvalues of a symmetric matrix are real.    Let be an eigenvalue of with corresponding eigenvector that is:     Left multiply by    resulting in   Next, take the transpose of and recall that  where the symmetry of has been employed. Take the complex conjugate of the above equation: where has been used because is a real matrix. Right multiply this by  Solving this for results in which is identical to showing that which shows that is real.   "
},
{
  "id": "sect-orthogonal-matrices-2-6",
  "level": "2",
  "url": "sect-orthogonal-matrices.html#sect-orthogonal-matrices-2-6",
  "type": "Theorem",
  "number": "5.3.3",
  "title": "",
  "body": "  The eigenvectors of a symmetric matrix are orthogonal.    Let and be two distinct eigenvalues of a symmetric matrix with corresponding eigenvectors and . Then and Left multiply the first equation by and the second equation by to get Since is symmetric, then . Therefore, Since the eigenvalues are distinct, then which implies that .   "
},
{
  "id": "sect-orthogonal-matrices-2-7",
  "level": "2",
  "url": "sect-orthogonal-matrices.html#sect-orthogonal-matrices-2-7",
  "type": "Definition",
  "number": "5.3.4",
  "title": "",
...
{
  "id": "thm-orthogonal-inverse",
  "level": "2",
  "url": "sect-orthogonal-matrices.html#thm-orthogonal-inverse",
  "type": "Theorem",
  "number": "5.3.5",
  "title": "",
...
{
  "id": "sect-orthogonal-matrices-2-10",
  "level": "2",
  "url": "sect-orthogonal-matrices.html#sect-orthogonal-matrices-2-10",
  "type": "Proof",
  "number": "1",
  "title": "",
  "body": " This is the same as showing that , which is the definition of an orthonormal matrix.  "
},
{
  "id": "thm-orthogonal-determinant",
  "level": "2",
  "url": "sect-orthogonal-matrices.html#thm-orthogonal-determinant",
  "type": "Theorem",
  "number": "5.3.6",
  "title": "",
  "body": "  If is an orthogonal matrix, then or .    Recall that from , then from  Then since the determinant is a real number, then or .   "
},
{
  "id": "sect-orthogonal-as-transformation-3",
  "level": "2",
  "url": "sect-orthogonal-matrices.html#sect-orthogonal-as-transformation-3",
  "type": "Proof",
  "number": "5.3.1.1",
  "title": "",
  "body": " The proof of the length is shown and the remainder is left to the reader. Without loss of generality, we will find the square of the length of the vector or where is used from .  "
},
{
...
{
  "id": "sect-solve-linear-system-lu-6",
  "level": "2",
  "url": "sect-lu-factorization.html#sect-solve-linear-system-lu-6",
  "type": "Example",
  "number": "6.1.6",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "ch-matrix-factoring-4.html#sect-orthogonal-transformations-2",
  "type": "Definition",
  "number": "6.2.12",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "ch-matrix-factoring-4.html#sect-orthogonal-transformations-3",
  "type": "Example",
  "number": "6.2.13",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "ch-matrix-factoring-4.html#sect-orthogonal-transformations-4",
  "type": "Definition",
  "number": "6.2.14",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "ch-matrix-factoring-4.html#sect-orthogonal-transformations-6",
  "type": "Example",
  "number": "6.2.15",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "ch-matrix-factoring-4.html#sect-orthogonal-transformations-10",
  "type": "Example",
  "number": "6.2.16",
  "title": "",
...
},
{
  ...
  "body": " QR Factorization   The QR factorization of a matrix is a decomposition of a matrix into the product of an orthogonal matrix and an upper triangular matrix. This factorization is useful in solving systems of linear equations, computing eigenvalues, and in numerical linear algebra.    The QR factorization of a matrix is given by   where is an orthogonal matrix and is an upper triangular matrix.      QR Factorization Algorithm  The QR-factorization can be performed using the Gram-Schmidt orthogonalization seen in . We will first show this with an example and then explain why this works.    Perform Gram-Schmidt Orthogonalization to find an orthonormal set of vectors of the columns of     and then use the resulting matrix to find using     Let be the columns of and we will call the resulting orthogonal vectors as .     For the second vector, and then this vectors is normalized with   Lastly, the third column of can be found with and lastly, we normalize this vector as and thus the matrix is the matrix with these three vectors or   Lastly, we find with     A natural question to ask is why does this work? Why does the Gram-Schmidt process give us the QR factorization? The answer is that the Gram-Schmidt process gives us an orthonormal basis for the column space of and thus the matrix is an orthogonal matrix. Then, the matrix is the change of basis matrix from the standard basis to the orthonormal basis given by the columns of .  Examining the result of , the matrix projects the columns of onto . Because is constructed as the    Solving Linear Systems with QR factoring.  We can solving linear systems with the QR factorization and is often done if the original matrix is difficult to solve (Section where this is explained??). Let's look the example in .     Write     Solve . Note that is upper triangular and thus this can be solved with back substitution.       Solve the linear system using the -decomposition where     First, we need to find the factorization. We can follow the same steps using Gram-Schmidt Orthogonalization as in , however, generally the resulting elements of are not rational, so we will resort to software to do this. Using Matlab or Julia, the result in and this just shows the first 5 or so digits of the two matrices.  The next step is to find or   And lastly, we solve . This is done with back-substitution. The result of this is: which is close to the answer found in , the difference being that here we used floating-point numbers which have round off errors.      Using QR factorization to find Eigenvalues  Another use of -factorization is that of numerically estimating the eigenvalues of a matrix.    The matrix for orthogonal matrix and upper triangular matrix has the same eigenvalues as .    This amounts to showing that the matrices and are similar. Let and since is orthogonal, then      We use this fact to generate the following algorithm    The following steps generates a sequence of matrices . In the limit goes to the diagonal matrix with the eigenvalues of on the diagonal.     Let and     Factor where is othogonal and is upper triangular.    Let . That is, reverse the order of the matrix multiplies.    If the maximum of the absolute value of the lower left elements of is within , then stop. Otherwise increment by 1 and return to step 2.       We will show an example of this in action and then prove later why this converges to the correct answer.    Estimate the eigenvalues of the matrix as found in     First let . Then factor into and , where . This is done with software. If using Julia,   QR₀ = qr(A₀)   and the matrices are then located in Matrix(QR₀.Q) Note: if you leave off the Matrix , then the matrix QR₀.Q is in a compact form. or  3×3 Matrix{Float64}:  -0.267261 0.145479 -0.952579  -0.801784 -0.581914 0.136083  -0.534522 0.800132 0.272166  and QR₀.R or  3×3 Matrix{Float64}:  -3.74166 1.06904 -6.41427  0.0 1.96396 -1.09109  0.0 0.0 1.63299    Then the order of the matrices is reversed to A₁ = QR₀.R * QR₀.Q , resulting in  3×3 Matrix{Float64}:  3.57143 -6.29869 1.96396  -0.99146 -2.01587 -0.0296957  -0.872872 1.30661 0.444444    Recall that the algorithm is supposed to result in an upper triangular matrix . We'll do one more step by hand. Let QR₁ = qr(A₁) . This gives us the two matrices (which we won't show here), but the next matrix is found by reversing the and with A₂ = QR₁.R * QR₁.Q resulting in  3×3 Matrix{Float64}:  4.65025 -4.45991 -2.88562  0.830799 -3.49591 -0.700881  0.199152 0.000981054 0.845661    Notice that the numbers in the lower right are getting smaller, but not very quickly. We'll do a number of steps with   Aₖ = A for i=1:25 QRₖ = qr(Aₖ) Aₖ = QRₖ.R * QRₖ.Q end Aₖ   and the result is    3×3 Matrix{Float64}:  3.99934 -5.00092 3.53563  -0.000921692 -2.99934 0.706641  -2.34445e-15 1.27349e-12 1.0    The terms in the lower left are quite close to zero, so we can estimate that the eigenvalues are the diagonal elements or 3.99934, -2.9934 and 1.0 .    We now discuss why this works.   "
},
{
  "id": "sec-qr-factorization-2-2",
  "level": "2",
  "url": "sec-qr-factorization.html#sec-qr-factorization-2-2",
  "type": "Definition",
  "number": "6.3.1",
  "title": "",
  "body": "  The QR factorization of a matrix is given by   where is an orthogonal matrix and is an upper triangular matrix.   "
},
{
  "id": "ex-qr-factor",
  "level": "2",
  "url": "sec-qr-factorization.html#ex-qr-factor",
  "type": "Example",
  "number": "6.3.2",
  "title": "",
  "body": "  Perform Gram-Schmidt Orthogonalization to find an orthonormal set of vectors of the columns of     and then use the resulting matrix to find using     Let be the columns of and we will call the resulting orthogonal vectors as .     For the second vector, and then this vectors is normalized with   Lastly, the third column of can be found with and lastly, we normalize this vector as and thus the matrix is the matrix with these three vectors or   Lastly, we find with    "
},
{
  "id": "sect-solving-linear-systems-qr-4",
  "level": "2",
  "url": "sec-qr-factorization.html#sect-solving-linear-systems-qr-4",
  "type": "Example",
  "number": "6.3.3",
  "title": "",
  "body": "  Solve the linear system using the -decomposition where     First, we need to find the factorization. We can follow the same steps using Gram-Schmidt Orthogonalization as in , however, generally the resulting elements of are not rational, so we will resort to software to do this. Using Matlab or Julia, the result in and this just shows the first 5 or so digits of the two matrices.  The next step is to find or   And lastly, we solve . This is done with back-substitution. The result of this is: which is close to the answer found in , the difference being that here we used floating-point numbers which have round off errors.   "
},
{
  "id": "lem-eigenvalues-qr",
  "level": "2",
  "url": "sec-qr-factorization.html#lem-eigenvalues-qr",
  "type": "Lemma",
  "number": "6.3.4",
  "title": "",
  "body": "  The matrix for orthogonal matrix and upper triangular matrix has the same eigenvalues as .    This amounts to showing that the matrices and are similar. Let and since is orthogonal, then     "
},
{
  "id": "alg-qr-eigenvalues",
  "level": "2",
  "url": "sec-qr-factorization.html#alg-qr-eigenvalues",
  "type": "Algorithm",
  "number": "6.3.5",
  "title": "",
  "body": "  The following steps generates a sequence of matrices . In the limit goes to the diagonal matrix with the eigenvalues of on the diagonal.     Let and     Factor where is othogonal and is upper triangular.    Let . That is, reverse the order of the matrix multiplies.    If the maximum of the absolute value of the lower left elements of is within , then stop. Otherwise increment by 1 and return to step 2.      "
...
{
  "id": "sect-qr-eigenvalues-7",
  "level": "2",
  "url": "sec-qr-factorization.html#sect-qr-eigenvalues-7",
  "type": "Example",
  "number": "6.3.6",
  "title": "",
  "body": "  Estimate the eigenvalues of the matrix as found in     First let . Then factor into and , where . This is done with software. If using Julia,   QR₀ = qr(A₀)   and the matrices are then located in Matrix(QR₀.Q) Note: if you leave off the Matrix , then the matrix QR₀.Q is in a compact form. or  3×3 Matrix{Float64}:  -0.267261 0.145479 -0.952579  -0.801784 -0.581914 0.136083  -0.534522 0.800132 0.272166  and QR₀.R or  3×3 Matrix{Float64}:  -3.74166 1.06904 -6.41427  0.0 1.96396 -1.09109  0.0 0.0 1.63299    Then the order of the matrices is reversed to A₁ = QR₀.R * QR₀.Q , resulting in  3×3 Matrix{Float64}:  3.57143 -6.29869 1.96396  -0.99146 -2.01587 -0.0296957  -0.872872 1.30661 0.444444    Recall that the algorithm is supposed to result in an upper triangular matrix . We'll do one more step by hand. Let QR₁ = qr(A₁) . This gives us the two matrices (which we won't show here), but the next matrix is found by reversing the and with A₂ = QR₁.R * QR₁.Q resulting in  3×3 Matrix{Float64}:  4.65025 -4.45991 -2.88562  0.830799 -3.49591 -0.700881  0.199152 0.000981054 0.845661    Notice that the numbers in the lower right are getting smaller, but not very quickly. We'll do a number of steps with   Aₖ = A for i=1:25 QRₖ = qr(Aₖ) Aₖ = QRₖ.R * QRₖ.Q end Aₖ   and the result is    3×3 Matrix{Float64}:  3.99934 -5.00092 3.53563  -0.000921692 -2.99934 0.706641  -2.34445e-15 1.27349e-12 1.0    The terms in the lower left are quite close to zero, so we can estimate that the eigenvalues are the diagonal elements or 3.99934, -2.9934 and 1.0 .   "
},
{
...
{
  "id": "sec-trig-poly-3-19",
  "level": "2",
  "url": "sec-trig-poly.html#sec-trig-poly-3-19",
  "type": "Remark",
  "number": "7.3.1",
  "title": "",
...
{
  "id": "sec-trig-poly-3-20",
  "level": "2",
  "url": "sec-trig-poly.html#sec-trig-poly-3-20",
  "type": "Example",
  "number": "7.3.2",
  "title": "",
